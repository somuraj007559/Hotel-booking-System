      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-2">📧 info@hotelbook.com</p>
            <p className="text-gray-400 mb-2">📞 +91 123 456 7890</p>
            <p className="text-gray-400">📍 123 Hotel Street, Mumbai, India</p>
          </div>
